...
\section{Education}
  ...
  {\begin{tabular}{P{2cm} P{7.5cm} P{6.5cm} P{3cm}}
      ...
      \hline
      2019-2023 & B.Tech in Computer Science \& Engineering & Indian Institute of Technology, Delhi & 9.387 \\
      \hline
...
\itemListStart{0.2}
  \schosItem
    {Woldquant Global Alphathon}
    {Our team secured \textbf{26$^{th}$ rank} out of 13k teams worldwide in stage-I}
    {2022}
  \schosItem
    {Department Change}
