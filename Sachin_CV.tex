  ...
  \listStart{0.05}{}
    ...
    \expHeading
      ...
      \itemListStart{0.2}
        ...
        \resumeItem{Utlized \textbf{four party model} of mastercard to design enitities and get transaction level and card level \textbf{embeddings}}
...
\itemListStart{0.2}
  ...
  \schosItem
    {Outstanding Grade}
    {One of \textbf{29} students in IITD to score 10 CGPA in every course in frst semester }
    {2019}
  \schosItem
    {IITD Semester Merit Award}
    {Conferred for ranking amongst \textbf{top 7\%} students in frst sem IITD  }
    {2019}    
  \schosItem
    {JEE Advanced}
...
\section{Projects}
    \listStart{0.05}{}
      ...
      \projectHeading
        ...
        {Aug, 2022 - Dec, 2022}
        \itemListStart{0.2}
          \resumeItem{Evaluated transferability \& adaptability of FrugalLight, a Reinfeorcment Learning based traffic signal controller}
          \resumeItem{Analysed different similarity metrics to explain learnability \& compare models trained without traffic simulator}
          % \resumeItem{}
        \itemListEnd
