...
\itemListStart{0.2}
  \schosItem
    {Department Change}
    {One of 13 students in IITD to secure discipline change to CSE on a merit basis}
    {2020}
  \schosItem
    {Outstanding Grade}
    {One of 29 students in IITD to score 10 CGPA in every course in frst semester }
    {2019}
  \schosItem
    {IITD Semester Merit Award}
    {Conferred for ranking amongst top 7\% students in frst sem IITD  }
    {2019}    
  \schosItem
    {JEE Advanced}
    {Secured All India Rank 168(OB) among 0.22 million candidates}
    {2019}    
  \schosItem
    {JEE Mains}
    {Secured All India Rank 190(OB) among 1.15 million candidates}
    {2019} 
  \schosItem
    {Olympiads}
    {School Gold Medalist and 2nd level selection in SOF Science and Mathematics Olympiad }
    {2017} 
  \itemListEnd
